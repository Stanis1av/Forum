...
RSpec.describe 'Comments API' do
  ...
  # Test suite for /articles/:article_id/comments
  ...
  # Test suite for PUT /article/:article_id/comments
  describe 'POST /article/:article_id/comments' do
    let(:valid_attributes) { { body: 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nulla rutrum tincidunt pharetra.', author: 'Visit Narnia', user_id: 1, article_id: 1 } }
    ...
    context 'when an invalid request' do
      ...
      it 'returns a failure message' do
        expect(response.body).to match(/Validation failed: Body can't be blank, Author can't be blank, User can't be blank/)
      end
    end
  end
